...
// tidak meneruskan, dan tidak menyimpan laporan — itu batasan proyek, dan
// layar ini adalah tempat paling mudah untuk melanggarnya kalau tidak hati-hati.
const PRASYARAT = [
  {
  ...
  return (
    <AppShell>
      <Halaman>
        ...
        <Judul sub="Eskalasi kamu lakukan sendiri lewat kanal resmi. PeKA hanya menunjukkan jalurnya dan syarat yang perlu kamu penuhi lebih dulu.">
        ...
        <Tombol className="mb-6" href="/adukan">
          Kembali ke pilihan masalah
        </Tombol>

        <p className="text-center text-kecil text-tinta-70">
          PeKA tidak menerima laporan, tidak meneruskan laporan, dan tidak menyimpan data aduanmu.
