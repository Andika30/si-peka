      ...
      <Halaman>
        ...
        <section className="mb-6">
          ...
          <Kartu aksen="adukan">
            ...
            <Tombol href="/adukan">Cari kanal penyelenggaraku</Tombol>
          </Kartu>
        </section>
        ...
        <section className="mb-6">
          ...
          <Kartu className="bg-white/60 shadow-none">
            ...
            <Tombol href="/adukan/eskalasi" jenis="garis">
        ...
        <p className="text-center text-kecil text-tinta-70">
          PeKA tidak menerima pengaduan dan tidak meneruskannya. Semua kontak di atas kamu hubungi
          langsung.
        </p>
      </Halaman>
    </AppShell>
