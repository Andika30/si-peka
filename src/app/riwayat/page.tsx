...
import { BookOpen, Gamepad2, LineChart } from "lucide-react";
...
const TAB: { id: Saring; label: string }[] = [
  ...
  { id: "pengukuran", label: "Cek awal & akhir" },
];

const IKON = { modul: BookOpen, simulasi: Gamepad2, pengukuran: LineChart };
        ...
        {tampil.length === 0 ? (
          <div className="rounded-kartu border border-dashed border-garis p-12 text-center">
            ...
            <p className="text-isi text-tinta-70">
              Belum ada aktivitas di kategori ini. Mulai dari modul pertama untuk mengisi riwayat.
            </p>
          </div>
        ) : (
